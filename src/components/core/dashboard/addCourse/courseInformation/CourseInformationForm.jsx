...
const CourseInformationForm = () => {
    ...
    const onSubmit = async(data) => {
        if(editCourse){
            if(isFormUpdated()){
                ...
                // if(currentValues.courseTags.toString() !== course.tag.toString()) {      //tags TO-DO
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='rounded-md border-richblack-700 bg-richblack-800 p-6 space-y-8 mt-11 '>
            <div>
                ...
                className='text-richblack-900 w-full'
                />
                {
                    errors.courseTitle && (
            ...
            <div className='relative'>
                ...
                <input
                    ...
                    className='w-full text-richblack-800 ml-5'
                />
