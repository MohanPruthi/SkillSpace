    ...
    return (
        <div>
           ...
           <section className="bg-richblack-700">
            ...
            <h2 className='text-center text-4xl font-semobold mt-10 text-richblack-5'>Reviews from Other learners</h2>
            {/* Review Slider here */}
            <div className='h-[300px] w-[300px] border border-pure-greys-5'></div>
